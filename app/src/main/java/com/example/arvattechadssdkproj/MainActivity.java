...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArvatAds.initializeAds(this);

        ArvatAds.enableTestMode(this);

        ArvatAds.showBanner(MainActivity.this,rlBanner,1);
        ArvatAds.showNative(MainActivity.this,rl_native,tv_space,3, ArvatAds.AdTemplate.NATIVE_100);
//        consentForm();
                                    ...
                                    new ConsentForm.OnConsentFormDismissedListener() {
                                        ...
                                        public void onConsentFormDismissed(@Nullable FormError formError) {
                                            if (consentInformation.getConsentStatus() == ConsentInformation.ConsentStatus.OBTAINED) {
                                                ...
                                                ArvatAds.showBanner(MainActivity.this,rlBanner,1);
                                                ArvatAds.showNative(MainActivity.this,rl_native,tv_space,1, ArvatAds.AdTemplate.NATIVE_50);
                                            }
